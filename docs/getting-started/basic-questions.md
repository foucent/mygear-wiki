...
For the next layer—speed, spin, control, power, and reserve power—see [Key Performance Metrics When Buying a Blade](../advanced/blade-performance-metrics.md). For elasticity, hardness, and core wood, see [Elasticity, Hardness, and Core Wood](../advanced/gear-philosophy.md).

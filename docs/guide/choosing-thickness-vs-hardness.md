...
!!! note "The 4.0 mm rule"
    ITTF: topsheet + sponge + glue + booster must stay **≤ 4.0 mm**. A **2.15 mm** sponge plus thick glue and multi-boost can fail a thickness check. Pros often stay at **2.1 mm** and climb hardness (41° / 42°) for more power with less rule risk.
...
Related: [Hurricane Blue vs Orange Sponge](hurricane-blue-vs-orange-sponge.md) · [Boosting Truth](boosting-truth.md) · [Hurricane 3 Multi-Stage Boosting](../guide/hurricane-3-multi-stage-boosting.md)
